...
public class ChatService : IChatService
{
    ...
    /// </summary>
    public async Task SaveMessageAsync(Guid requestId, string userId, string message,
    ...
    /// </summary>
    public async Task<IEnumerable<ChatMessage>> GetMessagesAsync(Guid requestId,
        CancellationToken cancellationToken = default)
    {
