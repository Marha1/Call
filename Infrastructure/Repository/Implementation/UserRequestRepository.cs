...
public class UserRequestRepository : BaseRepository<UserRequest>, IUserRequestRepository
{
    ...
    public IQueryable<UserRequest>? GetUserRequestsAsync(string userId, ODataQueryOptions<UserRequest>? queryOptions, CancellationToken cancellationToken = default)
    {
